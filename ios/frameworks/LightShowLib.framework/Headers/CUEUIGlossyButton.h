...
} CUEUIGlossyButtonExtraShadingType;
...
@interface CUEUIGlossyButton : UIButton
...
@property (nonatomic, assign) CUEUIGlossyButtonStrokeType strokeType UI_APPEARANCE_SELECTOR;	// outer button border
@property (nonatomic, assign) CUEUIGlossyButtonExtraShadingType extraShadingType UI_APPEARANCE_SELECTOR;	// extra shading effect other than gradient
...
- (void) setGradientType : (CUEUIGlossyButtonGradientType) type;
...
@interface UIGNavigationButton : CUEUIGlossyButton

@property (nonatomic, getter = isLeftArrow) BOOL leftArrow;

@end

@interface UIGBadgeButton : CUEUIGlossyButton
